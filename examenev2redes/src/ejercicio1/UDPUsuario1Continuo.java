...
public class UDPUsuario1Continuo {
    public static void main(String[] args) {
        // Puertos de comunicación
        int puertoRecepcion = 9876; // Puerto donde escucha Usuario1
        int puertoEmision = 9877;   // Puerto donde escucha Usuario2
        ...
        try (DatagramSocket socket = new DatagramSocket(puertoRecepcion)) {
            ...
            System.out.println("Usuario 1 - Iniciando conversación...");
            ...
            while (true) {
                // ENVIAR MENSAJE
                System.out.print("Usuario 1: "); // Solicitar mensaje al usuario
                ...
                if (mensajeEnviar.equals("*")) {
                    ...
                    System.out.println("Usuario 1 - Esperando confirmación de Usuario 2...");
                }
                ...
                System.out.println("Usuario 2: " + mensajeRecibido); // Mostrar el mensaje recibido en la consola
